...
Route::middleware(['auth'])->group(function () {
    // 3)Use Gate Authorization with Route
    // Route To View Post Page with Gate Authorization
    Route::get('post',[PostController::class, 'index'])->middleware(['auth','can:isAdmin'])->name('post_index');
