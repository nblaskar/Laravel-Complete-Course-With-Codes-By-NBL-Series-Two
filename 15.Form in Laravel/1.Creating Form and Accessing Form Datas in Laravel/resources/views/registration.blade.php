...
<body>
    ...
    <hr>
       {{-- csrf:- It is important for all request methods for providing security for this form --}}
        {{-- it provides a token which is used for form validation by laravel --}}
    ...
    {{--To Presearve the form Filed Data After Also Submit --}}
    {{-- <form action="" method="post">
        @csrf
