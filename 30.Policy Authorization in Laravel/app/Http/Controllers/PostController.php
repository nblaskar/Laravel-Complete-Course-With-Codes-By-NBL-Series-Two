...
class PostController extends Controller
{
    ...
    {
        // 6)Using Policy Authorization Via Controller
        $this->authorize('isAdmin', Post::class);
        // Note: Post Model is not there so have to use Post Mode Class otherwise can use $post Model object
        
        // 7)Using Policy Authorization Via User Model in Controller
